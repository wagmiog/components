...
import { LANDING_PAGE, SUPPORTED_WALLETS, AVALANCHE_CHAIN_PARAMS, IS_IN_IFRAME, WalletInfo } from 'src/constants'
            ...
            {web3Error instanceof UnsupportedChainIdError ? (
              <>
                ...
                {isMetamaskOrCbWallet && (
                  <Button variant="primary" onClick={addAvalancheNetwork}>{t('walletModal.switchAvalanche')}</Button>
                )}
              </>
            ) : (
