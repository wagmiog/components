...
import { clearAllTransactions } from 'src/state/ptransactions/actions'
...
import { gnosisSafe, injected, walletconnect, walletlink } from 'src/connectors'
import Identicon from 'src/components/Identicon'
import { Button } from 'src/components/Button'
import { ExternalLink as LinkIcon } from 'react-feather'
import { ExternalLink, LinkStyledButton, TYPE } from 'src/theme'
...
const WalletAction = styled(Button)<{ isBeta: boolean }>`
